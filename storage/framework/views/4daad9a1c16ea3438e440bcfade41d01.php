  ...
  <div class="card">
    ...
    <div class="card-body pt-4 p-3">
      <form action="<?php echo e(route('admin.currencies.update', $currency->id)); ?>" method="POST">
        ...
        <?php echo $__env->make('currencies._form', ['currency' => $currency], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/currencies/edit.blade.php ENDPATH**/ ?>