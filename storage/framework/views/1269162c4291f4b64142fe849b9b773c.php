                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            <h1>
                              <?php echo e(App::isLocale('en') ? $page->title_en : $page->title_ar); ?>
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"><?php echo e(App::isLocale('en') ? $page->title_en : $page->title_ar); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="section-image-box style-one mb-3" data-aos="fade-up" data-aos-delay="30" data-aos-duration="1000">
                                <div class="image-one">
                                    <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/tb4204928_5.jpg')); ?>" alt="About Image">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="section-content-box style-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                                <div class="section-title mb-2">
                                    ...
                                    <h2 class="mb-2"><?php echo e(App::isLocale('en') ? $page->title_en : $page->title_ar); ?></h2>
                                </div>
                                <p class="mb-1"><?php echo App::isLocale('en') ? $page->content_en : $page->content_ar; ?>.</p>
  ...
  <div class="col-xl-12">
                            ...
                            <div class="section-content-box style-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                                <div class="section-title mb-2">
                                    <div class="sub-heading d-inline-flex align-items-center">
                                        <i class="flaticon-sparkler"></i>
                                        <span class="sub-title"><?php echo e(App::isLocale('en') ? $page->title_en : $page->title_ar); ?></span>
                                    </div>
                                    <h2 class="mb-2"> <?php echo e(App::isLocale('en') ? $page->title_en : $page->title_ar); ?></h2>
                                </div>
                                <p class="mb-1"><?php echo App::isLocale('en') ? $page->content_en : $page->content_ar; ?>.</p>
                                ...
                                <div class="terms-agreement-box mt-4 mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="agreeTerms">
                                        <label class="form-check-label" for="agreeTerms">
                                            I agree to the <a href="#" style="color: #d4a574; text-decoration: underline;">Terms and Conditions</a>
                                        </label>
                                    </div>
                                </div>
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/page.blade.php ENDPATH**/ ?>