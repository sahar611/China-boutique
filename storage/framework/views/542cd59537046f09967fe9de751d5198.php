...
<main class="main-bg">
     <!--====== Start Page Banner Section ======-->
            ...
            <div class="page-banner-wrapper p-r z-1">
                ...
                <div class="shape shape-three"><span><img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/shape/curved-arrow.png')); ?>" alt=""></span>
                </div>
   ...
   <!--===== Start brand Section  ======-->
        <section class="category-section pt-5 pb-2 overflow-hidden dir-rtl">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <!--=== Section Title  ===-->
                        <div class="section-title  text-center text-md-start mb-4" data-aos="fade-right"
                            ...
                            <h2><?php echo e(__('home.Browse_All_Brands')); ?></h2>
                        </div>
                    </div>
                <div class="col-lg-4">
                            <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30" data-aos-duration="1200">
                                    <form method="GET" action="<?php echo e(route('brands')); ?>" >

                                    <input type="text" name="q" value="<?php echo e($q); ?>"  class="form_control" placeholder="Search Brands" required>
                ...
                <div class="category-wrapper pt-2 brand-all ">
                    <div class="row justify-content-center">
                         <?php $__empty_1 = true; $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <!--=== Category Item  ===-->
                            <div class="category-item style-two mb-3 back-red-h" data-aos="fade-up" data-aos-delay="10"
                                data-aos-duration="800">
                                <div class="category-img">
                                    <img src="<?php echo e(asset($brand->logo)); ?>" alt="  <?php echo e(app()->getLocale() === 'ar' ? $brand->name_ar : $brand->name_en); ?>">
                                </div>
                                <div class="category-content">
                                    <a href="<?php echo e(route('brand.products', $brand->slug)); ?>" class="category-btn">  <?php echo e(app()->getLocale() === 'ar' ? $brand->name_ar : $brand->name_en); ?></a>
                                    <span><?php echo e(str_pad($brand->products_count, 2, '0', STR_PAD_LEFT)); ?>  <?php echo e(__('home.items')); ?></span>
                                </div>
                            </div>
                        </div>
    ...
    <?php endif; ?>
                    ...
                    <div class="row text-center mt-4">
                       ...
                       <?php echo e($brands->onEachSide(1)->links('front.layouts.pagination')); ?>
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/brands.blade.php ENDPATH**/ ?>