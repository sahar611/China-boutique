        ...
        <section class="hero-section">
            ...
            <div class="hero-wrapper-two">
                ...
                <div class="hero-shape bg_cover d-none d-xl-block"
                    style="background-image: url(<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/hero/hero-two-shape1.png')); ?>);"></div>
                <!--=== Hero Image ===-->
                <div class="hero-image d-none d-xl-block">
                    ...
                    <div class="hero-img-shape"><img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/hero/hero-two-img-shape1.png')); ?>" alt="Image Shape">
                    </div>
                </div>
                <div class="container">
                    <div class="row">
...
?>
                                ...
                                <div class="single-hero-post">
                                    <div class="hero-content style-two">
                                        ...
                                        <p><?php echo e(app()->getLocale() == 'ar' ? $banner->description_ar : $banner->description); ?> </p>
                                            ...
                                            <div class="product-info-wrap">
                                                ...
                                                <div class="product-price">
                                                    <span class="price prev-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?></span><?php echo e(number_format($bestSeller->price * $currentCurrency->rate, 2)); ?></span>
                                                    <span class="price new-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?></span><?php echo e(number_format($bestSeller->sale_price * $currentCurrency->rate, 2)); ?></span>
                                                </div>
                                                <?php else: ?>
                                                <div class="product-price">
                                                   
                                                    <span class="price new-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?>

</span><?php echo e(number_format($bestSeller->price * $currentCurrency->rate, 2)); ?></span>
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        ...
                                        <div class="product-item style-one mb-40 back-p">
                                            ...
                                            <div class="product-info-wrap">
                                                ...
                                                <div class="product-price">
                                                    <span class="price prev-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?></span><?php echo e(number_format($newProduct->price * $currentCurrency->rate, 2)); ?></span>
                                                    <span class="price new-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?></span><?php echo e(number_format($newProduct->sale_price * $currentCurrency->rate, 2)); ?></span>
                                                </div>
                                                <?php else: ?>
                                                <div class="product-price">
        ...
        <section class="features-products-section pt-5 pb-2 overflow-hidden">
            <div class="container">
              ...
              <?php $__currentLoopData = $homeProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="product-item style-one mb-40 back-p">
                        <div class="product-thumbnail">
                            <img src="<?php echo e($homeProduct->mainImageProduct? asset($homeProduct->mainImageProduct->path) : asset('assets/images/products/default.png')); ?>" alt="Products">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="features-wrapper" data-aos="fade-up" data-aos-delay="10" data-aos-duration="1000">
                            ...
                            <div class="divider mb-25">
                                <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/divider.png')); ?>" alt="divider">
                            </div>
                            <!--=== Iconic Box Item ===-->
                            <div class="iconic-box-item icon-left-box mb-25">
                                <div class="icon">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="banner-item style-one bg-one mb-40" data-aos="fade-up" data-aos-delay="10"
                            ...
                            <div class="shape shape-one"><span><img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/banner/discount.png')); ?>"
                                        alt="shape"></span></div>
                            <div class="shape shape-two"><span><img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/banner/line.png')); ?>"
                                        alt="shape"></span></div>
                            <div class="banner-img"><img src="<?php echo e($banner->image ? asset($banner->image) : asset('assets/images/banner/banner-1.png')); ?>" alt="banner image">
                            </div>
                ...
                <div class="trending-products-slider" data-aos="fade-up" data-aos-duration="1400">
                   <?php $__currentLoopData = $trendingNow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="product-item style-two">
                        <div class="product-thumbnail">
                            <img src="<?php echo e($trending->mainImageProduct? asset($trending->mainImageProduct->path) : asset('assets/images/products/default.png')); ?>" alt="Products">
                        </div>
                        <div class="product-info-wrap">
                            <div class="product-info">
                                <ul class="ratings rating5">
                             ...
                             <?php if($trending->sale_price): ?>
                                                <div class="product-price">
                                                    <span class="price prev-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?></span><?php echo e(number_format($trending->price * $currentCurrency->rate, 2)); ?></span>
                                                    <span class="price new-price"><span
                                                            class="currency"><?php echo e($currentCurrency->symbol); ?></span><?php echo e(number_format($trending->sale_price * $currentCurrency->rate, 2)); ?></span>
                                                </div>
                                                <?php else: ?>
                                                <div class="product-price">
        ...
        <section class="newsletter-section">
            <div class="newsletter-wrapper-two p-r z-1 pt-80 pb-85">
                <div class="newsletter-image-two" data-aos="fade-left" data-aos-duration="1200"><img
                        src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/hannah-morgan-ycVFts5Ma4s-unsplash.jpg')); ?>" alt="newsletter image"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6">
