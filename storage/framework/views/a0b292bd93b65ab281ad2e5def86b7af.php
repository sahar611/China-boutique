                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"><?php echo e(__('home.login')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                      ...
                      <form class="pesco-contact-form mt-3" action="<?php echo e(route('customer.login.post')); ?>" method="POST">
    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-12">
            <div class="text-center mt-3">
                <p>Don't have an account?
                    <a href="<?php echo e(route('customer.register')); ?>" class="text-primary fw-bold">Sign Up</a>
                </p>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/auth/login.blade.php ENDPATH**/ ?>