...
<div class="container-fluid py-4">
  <div class="card">
    ...
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
      <h5 class="mb-0"><?php echo e(__('messages.edit_product')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <textarea name="description_en" rows="5" class="form-control <?php $__errorArgs = ['description_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description_en', $product->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6">
                ...
                <textarea name="description_ar" rows="5" class="form-control <?php $__errorArgs = ['description_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description_ar', $product->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6">
                ...
                <input type="number" step="0.01" name="sale_price" class="form-control <?php $__errorArgs = ['sale_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-4">
                ...
                <input type="number" name="home_sort" class="form-control <?php $__errorArgs = ['home_sort'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('home_sort', $product->home_sort ?? 0)); ?>">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="tab-pane fade" id="tab-media" role="tabpanel" aria-labelledby="tab-media-tab">
            <div class="row">
              <div class="col-md-6">
                <label class="form-label"><?php echo e(__('messages.add_images')); ?></label>
                ...
                <div class="col-md-3 mb-3">
                  <div class="card">
                    ...
                    <div class="card-body p-2">
                      ...
                      <?php else: ?>
                        <form method="POST" action="<?php echo e(route('admin.products.images.main', [$product->id, $img->id])); ?>" style="display:block;">
                          <?php echo csrf_field(); ?>
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <input type="number" step="0.01" min="0" name="variants[0][length]" class="form-control"
                         value="<?php echo e(old('variants.0.length', $dim['length'] ?? '')); ?>">
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" step="0.01" min="0" name="variants[0][width]" class="form-control"
                         value="<?php echo e(old('variants.0.width', $dim['width'] ?? '')); ?>">
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" step="0.01" min="0" name="variants[0][height]" class="form-control"
                         value="<?php echo e(old('variants.0.height', $dim['height'] ?? '')); ?>">
                </div>

                <div class="col-md-3">
                  <label class="form-label"><?php echo e(__('messages.unit')); ?></label>
                  <?php $unit = old('variants.0.unit', $dim['unit'] ?? 'cm'); ?>
