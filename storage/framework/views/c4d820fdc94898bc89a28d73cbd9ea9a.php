                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"><?php echo e(__('home.register')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-wrapper p-r z-1 back-all-form" data-aos="fade-right" data-aos-delay="10"
                          ...
                          <div class="text-center ">
                           ...
                           <form class="pesco-contact-form mt-3" action="<?php echo e(route('customer.register.post')); ?>" method="POST">
    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <input type="text"
                       ...
                       class="form_control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <input type="email"
                       placeholder="Email"
                       class="form_control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <input type="text"
                       placeholder="Phone"
                       class="form_control <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
         ...
         <div class="col-lg-12">
            <div class="form-group">
                <input type="text"
                       placeholder="address"
                       class="form_control <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
        ...
        <div class="col-lg-12">
            <div class="form-group" style="position: relative;">
                <input type="password"
                       ...
                       class="form_control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
        ...
        <div class="col-lg-12">
            <div class="text-center mt-3">
                <p>Already have an account?
                    <a href="<?php echo e(route('customer.login')); ?>" class="text-primary fw-bold">Login</a>
                </p>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/auth/register.blade.php ENDPATH**/ ?>