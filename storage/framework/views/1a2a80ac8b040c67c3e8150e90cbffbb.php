...
<main class="main-bg">
  ...
  <!--====== Start Blog Section  ======-->
        <section class="blog-section pt-5 pb-5 dir-rtl">
            <div class="container">
                <!--====== Blog Wrapper  ======-->
                <div class="blogs-wrapper">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-sm-12">
                            <!--=== Blog Post Item ===-->
                            <div class="blog-post-item style-two mb-25 ">
                                <div class="post-thumbnail">
                                    <img src="<?php echo e(asset($n->cover)); ?>" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
                                    <div class="post-meta">
                                        <span><a href="<?php echo e(route('news.show', $n->slug)); ?>"> <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/icon/star-3.svg')); ?>" alt="star icon">  
                                            <?php echo e(optional($n->published_at)->format('M d')); ?> ,<?php echo e(optional($n->published_at)->format('Y')); ?>

                                            <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/icon/star-3.svg')); ?>"
                                                    alt="star icon"></a></span>
                                    </div>
                                    <h3 class="title"><a href="<?php echo e(route('news.show', $n->slug)); ?>"> <?php echo e(App::isLocale('en') ? $n->title_en : $n->title_ar); ?></a></h3>


                                    <p><?php echo e(\Illuminate\Support\Str::limit(strip_tags(App::isLocale('en') ? $n->content_en : $n->content_ar), 140)); ?></p>
                    ...
                    <div class="row">
                        <div class="col-xl-12 mt-4">
                             ...
                             <?php echo e($news->onEachSide(1)->links('front.layouts.pagination')); ?>
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/blogs.blade.php ENDPATH**/ ?>