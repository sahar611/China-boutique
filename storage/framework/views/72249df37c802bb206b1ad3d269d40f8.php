...
<main class="main-bg">
                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"><?php echo e(__('home.trending')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="trending-products-section pt-5 pb-2 overflow-hidden dir-rtl">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <!--=== Section Title  ===-->
                    ...
                    <div class="col-lg-4">
                        <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30"
                           ...
                           <form method="GET" action="<?php echo e(route('trending')); ?>">
                                <input type="text" class="form_control" name="q" value="<?php echo e(request('q')); ?>" placeholder="Search  products" required>
                ...
                <div class="category-wrapper pt-2 all-cat-padd trend">
                    <div class="row ">
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-12 text-center">
                            <?php echo e($trendingNow->onEachSide(1)->links('front.layouts.pagination')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/trending.blade.php ENDPATH**/ ?>