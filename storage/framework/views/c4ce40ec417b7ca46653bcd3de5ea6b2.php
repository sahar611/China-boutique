...
<main class="main-bg">
   ...
   <!--====== Start Faqs Section  ======-->
<section class="faqs-section pt-5 pb-5 <?php echo e(app()->getLocale() == 'ar' ? 'dir-rtl' : ''); ?>">
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30" data-aos-duration="1200">
                    <form>
                        <input type="search"
                               class="form_control"
                               placeholder="<?php echo e(app()->getLocale() == 'en' ? 'Search FAQs' : 'ابحث في الأسئلة'); ?>">
                ...
                <div class="accordion" id="accordionOne">
                    ...
                    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="accordion-item style-one mb-25"
                             data-aos="fade-up"
                             data-aos-delay="<?php echo e(20 + ($index * 5)); ?>"
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/faqs.blade.php ENDPATH**/ ?>