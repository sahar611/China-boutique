...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!--====== Flaticon css ======-->
    <link rel="stylesheet" href="<?php echo e(asset('frontend/'.App::getLocale().'/assets/fonts/flaticon/flaticon_pesco.css')); ?>">
    <!--====== FontAwesome css ======-->
    ...
    <!--====== Animate css ======-->
    <link rel="stylesheet" href="<?php echo e(asset('frontend/'.App::getLocale().'/assets/vendor/aos/aos.css')); ?>">
    <!--====== Default css ======-->
...
<body>
    ...
    <div class="preloader">
        <div class="loader">
            <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/loader.gif')); ?>" alt="Loader">
        </div>
    </div>
    <!--======  Start Overlay  ======-->
                        ...
                        <div class="top-left">
                            <ul>
                                <li class="d-lg-block d-none">
                                    <span><i class="fas fa-shipping-fast"></i><?php echo e(__('home.free_shipping')); ?></span>
                                </li>
                                <li>
...
?>
        ...
        <!--===  Search Header Main  ===-->
        <div class="search-header-main bg_cover" style="background-image: url(<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/hero/hero-two-shape1.png')); ?>);
                    ...
                    <div class="nav-inner-menu">
                        ...
                        <div class="main-categories-wrap d-none d-lg-block">
                            <a class="categories-btn-active" href="#">
                                <span class="fas fa-list"></span><span class="text"><?php echo e(__('home.Products_Category')); ?><i
                                ...
                                <div class="categori-dropdown-item">
                                    <ul>
                                         <?php $__currentLoopData = $homeSidebarCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeSidebarCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <li>
                                            <a href="#"> <img src="<?php echo e(asset($homeSidebarCategory->image)); ?>" alt="  <?php if(App::isLocale('en')): ?> <?php echo e($homeSidebarCategory->name_en); ?><?php else: ?> <?php echo e($homeSidebarCategory->name_ar); ?><?php endif; ?>">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="menu-item has-children"><a href="#"><?php echo e(__('home.brands')); ?></a>
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li><a href="#">  <?php if(App::isLocale('en')): ?> <?php echo e($topBrand->name_en); ?><?php else: ?> <?php echo e($topBrand->name_ar); ?><?php endif; ?></a></a></li>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <?php echo $__env->yieldContent('content'); ?>   
    ...
    <!--====== Jquery js ======-->
    <script src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/vendor/jquery-3.7.1.min.js')); ?>"></script>
    <!--====== Bootstrap js ======-->
    <script src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/vendor/popper/popper.min.js')); ?>"></script>
    <!--====== Bootstrap js ======-->
    <script src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <!--====== Slick js ======-->
    ...
    <!--====== SimplyCountdown js ======-->
    <script src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/vendor/simplyCountdown.min.js')); ?>"></script>
    <!--====== Aos js ======-->
