...
<main class="main-bg">
                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"><?php echo e(__('home.wishlist')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="wishlist-page-section pt-5 pb-5 dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <!--=== Cart Wrapper ===-->
                    <div class="cart-wrapper" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1000">
                        ...
                        <div class="cart-list table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th><i class="fas fa-tshirt"></i> <?php echo e(__('home.Products_Details')); ?></th>
                                        <th><i class="fas fa-sack-dollar"></i> <?php echo e(__('home.Unit_Price')); ?></th>
                                        <th><i class="fas fa-eye"></i> <?php echo e(__('home.Stock_Status')); ?></th>
                                        <th><i class="fas fa-rocket-launch"></i> <?php echo e(__('home.Action')); ?></th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $pName = app()->getLocale()==='ar' ? ($p->name_ar ?? $p->name_en) : ($p->name_en ??
                                    $p->name_ar);

                                    $img = $p->mainImageProduct?->path
                                    ? asset($p->mainImageProduct->path)
                                    : asset('frontend/'.App::getLocale().'/assets/images/products/cart-1.jpg');

                                    $basePrice = (float)($p->price ?? 0);
                                    $baseSale = (float)($p->sale_price ?? 0);
                                    $hasSale = $baseSale > 0 && $baseSale < $basePrice; $finalBase=$hasSale ? $baseSale
                                        : $basePrice; $final=$finalBase * ($currentCurrency->rate ?? 1);

                                        $inStock = !$p->track_stock || ((int)($p->stock ?? 0) > 0);
                                        $stockText = $p->track_stock
                                        ? ($inStock
                                        ? __('home.in_stock_with_qty', ['qty' => (int)$p->stock])
                                        : __('home.out_of_stock'))
                                        : __('home.in_stock');
                                        ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-thumb-item">
                                                    <div class="product-img">
                                                        <img src="<?php echo e($img); ?>" alt="<?php echo e($pName); ?>">
                                                    </div>
                                            ...
                                            <td>
                                                <div class="price">
                                                    <span class="currrency"><?php echo e($currentCurrency->symbol ?? '﷼'); ?></span>
                                                    <?php echo e(number_format($final, 2)); ?>
                                                ...
                                                <div class="text-muted" style="font-size: 12px;">
                                                    <del>
                                                        <span class="currrency"><?php echo e($currentCurrency->symbol ?? '﷼'); ?></span>
                                                        <?php echo e(number_format($basePrice * ($currentCurrency->rate ?? 1), 2)); ?>
                                            ...
                                            <td>
                                                <div class="product-stock <?php echo e($inStock ? '' : 'text-danger'); ?>">
                                            ...
                                            <td>
                                                <div class="action-cart">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-url="<?php echo e(route('cart.add', $p->slug)); ?>"
                                                    ...
                                                    <a href="javascript:void(0)" class="cart-remove js-wishlist-remove"
                                                        data-url="<?php echo e(route('wishlist.remove', $p->slug)); ?>"
                                                        aria-label="<?php echo e(__('home.remove')); ?>" style="cursor:pointer;">
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-center py-4 text-muted">
                                                <?php echo e(__('home.no_wishlist_items')); ?>
...
<script>
    document.addEventListener('click', async function (e) {
        const btn = e.target.closest('.js-wishlist-remove');
        if (!btn) return;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/wishlist.blade.php ENDPATH**/ ?>