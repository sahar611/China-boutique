                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="section-title  text-center text-md-start mb-4" data-aos="fade-right"
                            ...
                            <h2> <?php echo e(__('home.Browse_All_categories')); ?></h2>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30"
                            data-aos-duration="1200">

<form method="GET" action="<?php echo e(route('categories')); ?>" >

                                <input type="text" class="form_control"  name="q"
                           value="<?php echo e($q); ?>" placeholder="<?php echo e(__('Search Categories')); ?>" required>
                ...
                <div class="category-wrapper pt-2 all-cat-padd ">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            ...
                            <div class="category-item style-one text-center">
                                <div class="category-img">
                                    <img src="<?php echo e(asset($cat->image)); ?>" alt="category image">
                                </div>
                                <div class="category-content">
                                    <a href="<?php echo e(route('category.products', $cat->slug)); ?>" class="category-btn"> <?php echo e(app()->getLocale() === 'ar' ? $cat->name_ar : $cat->name_en); ?></a>
                                </div>
                            </div>
                        </div>
  ...
  <?php endif; ?>
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-12 text-center">
                           <?php echo e($categories->onEachSide(1)->links('front.layouts.pagination')); ?>
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/categories.blade.php ENDPATH**/ ?>