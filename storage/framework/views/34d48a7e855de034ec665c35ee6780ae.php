...
<main class="main-bg">
    ...
    <section class="page-banner dir-rtl">
                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"><?php echo e(__('home.orders')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
      ...
      <!--====== Start My Order Section ======-->
            <section class="cart-page-section pt-5 pb-5 dir-rtl">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="cart-wrapper mb-40" data-aos="fade-up" data-aos-duration="1200">
                                <h3 class="mb-20"><?php echo e(__('home.all_orders')); ?></h3>
                                <div class="cart-list table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th><i class="fas fa-tshirt"></i> <?php echo e(__('home.order_code')); ?></th>
                                               <th style="text-align: center;"><i class="fas fa-eye"></i><?php echo e(__('home.Quantity')); ?></th>
                                               
                                                <th style="text-align: right;"><i class="fas fa-money-bill"></i><?php echo e(__('home.total')); ?></th>
                                                
                                                    <th style="text-align: right;"><?php echo e(__('home.status')); ?></th>
                                                     <th style="text-align: right;"><?php echo e(__('home.date')); ?></th>
                                    ...
                                    <?php
                                        ...
                                        $cls = match($status) {
                                            ...
                                            'cancel', 'cancelled' => 'status-cancel',
                                            default => 'status-processing',
                                        };
                                    ?>
                                             <tr>
                                        <td>
                                            <strong>#<?php echo e($order->code ?? $order->id); ?></strong>
                                        ...
                                        <td style="text-align:center;">
                                            <?php echo e($order->items_count); ?> items
                                        </td>

                                        <td style="text-align:right;">
                                            <?php echo e(number_format((float)$order->total, 2)); ?>

                                            <span class="text-muted"><?php echo e($order->currency_code ?? 'SAR'); ?></span>
                                        </td>

                                        <td style="text-align:center;">
                                            <span class="<?php echo e($cls); ?>"><?php echo e($status); ?></span>
                                        </td>

                                        <td style="text-align:right;">
                                            <?php echo e(optional($order->created_at)->format('Y-m-d')); ?>

                                        </td>

                                        <!-- <td style="text-align:center;">
                                         
                                            <a href="" class="theme-btn style-one btn-sm">
                                                View
                                            </a>
                                        </td> -->
                                    </tr>
                                ...
                                <!-- <div class="cart-bottom d-flex align-items-center justify-content-between mt-40">
                                    <div class="ct-shopping">
                                        <button class="theme-btn style-one">Reorder</button>
                      ...
                      <div class="row text-center mt-4">
                        <div class="col-md-12 text-center">
                            <?php echo e($orders->onEachSide(1)->links('front.layouts.pagination')); ?>
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/auth/orders.blade.php ENDPATH**/ ?>