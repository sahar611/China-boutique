                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            ...
                            <div class="shop-sidebar-area" id="filterSidebar">
                                ...
                                <!--=== Product Widget ===-->
                                <div class="product-widget product-categories-widget mb-3" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1000">
                                    <div class="widget-content">
                                        <?php

  $selectedCategoryIds = (array) request()->get('category_ids', (isset($categoryId) && $categoryId ? [$categoryId] : []));
...
<form id="filtersForm" method="GET" action="<?php echo e(route('products')); ?>">
  ...
  <input type="hidden" name="to" id="toHidden" value="<?php echo e($priceTo ?? ''); ?>">
        ...
        >
                                ...
                                <!--=== Sidebar Widget ===-->
                                <div class="product-widget price-filter-widget mb-3 wow fadeInUp" data-aos="fade-up" data-aos-delay="20" data-aos-duration="400">
                                    <div class="widget-content">
                                        ...
                                        <div class="price-inputs-wrapper">
                                            <div class="row g-2">
                                                ...
                                                <input type="number" class="form-control" id="priceFrom" placeholder="0" min="0" value="<?php echo e($priceFrom ?? ''); ?>">                                                </div>
                                                <div class="col-6">
                                                    <label for="priceTo" class="form-label">To</label>
                                                 <input type="number" class="form-control" id="priceTo" placeholder="1000" min="0" value="<?php echo e($priceTo ?? ''); ?>">                                                </div>
                                            </div>
                                                 <button type="button" class="btn-submit-price mt-3" id="priceSubmitBtn">Submit</button>
                                        </div>
                                    </div>
                                </div>
                                <!--=== Sidebar Widget ===-->
                                <div class="product-widget product-categories-widget mb-3" data-aos="fade-up" data-aos-delay="30" data-aos-duration="600">
                                    <div class="widget-content">
                                            ...
                                            <div class="dropdown-menu-custom" id="brandsDropdownMenu">
                                                <ul class="categories-list">
                                                   <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $br): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <div class="form-check">
 <input class="form-check-input brand-checkbox" type="checkbox"  name="brand_ids[]" value="<?php echo e($br->id); ?>" id="br_<?php echo e($br->id); ?>" form="filtersForm"<?php if(in_array($br->id, $selectedBrandIds)): echo 'checked'; endif; ?> >                                                            
  ...
  <option value="new" <?php if(($sort ?? 'new')==='new'): echo 'selected'; endif; ?>>Sort by Newness</option>
...
<img src="<?php echo e($img ? asset($img) : asset('assets/images/placeholder.png')); ?>" alt="<?php echo e($product->name_en ?? 'Product'); ?>">
...
<a href="#" class="icon-btn js-wishlist-toggle <?php echo e($isWished ? 'is-active' : ''); ?>" data-url="<?php echo e(route('wishlist.toggle', $product->slug)); ?>" aria-label="wishlist"> <i class="<?php echo e($isWished ? 'fa fa-heart' : 'far fa-heart'); ?>"></i>
                                                ...
                                                <div class="cart-button">
                                                     <a href="javascript:void(0)" class="cart-btn js-add-to-cart" data-url="<?php echo e(route('cart.add', $product->slug)); ?>" data-qty-input=".quantity"><i class="far fa-shopping-basket"></i>
  ...
  $symbol = is_object($currency) ? ($currency->symbol ?? $currency->code ?? '') : ($currency['symbol'] ?? $currency['code'] ?? '');
  $priceDisplay = $finalBase * (float)$rate;

  $hasSale = $baseSale > 0 && $baseSale < $basePrice;
  $oldDisplay = $basePrice * (float)$rate;
?>

<div class="product-price">
  <?php if($hasSale): ?>
    <span class="price prev-price"><span class="currency"><?php echo e($symbol); ?></span><?php echo e(number_format($oldDisplay, 2)); ?></span>
    <span class="price new-price"><span class="currency"><?php echo e($symbol); ?></span><?php echo e(number_format($priceDisplay, 2)); ?></span>
  <?php else: ?>
    <span class="price new-price"><span class="currency"><?php echo e($symbol); ?></span><?php echo e(number_format($priceDisplay, 2)); ?></span>
  <?php endif; ?>
</div>
