    ...
    <div class="col-12">
        ...
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><?php echo e(__('messages.add_page')); ?></h5>
                ...
                <form action="<?php echo e(route('admin.pages.store')); ?>" method="POST">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="content_en" rows="8" class="form-control"><?php echo e(old('content_en')); ?></textarea>
                        </div>

                        <div class="col-md-6">
                            <label><?php echo e(__('messages.content_ar')); ?></label>
                            <textarea name="content_ar" rows="8" class="form-control"><?php echo e(old('content_ar')); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/pages/create.blade.php ENDPATH**/ ?>