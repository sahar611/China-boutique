...
<main class="main-bg">
    ...
    <section class="page-banner dir-rtl">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            <h1> <?php echo e(__('home.blog_details')); ?></h1>
                            <ul class="breadcrumb-link">
                                <li><a href="<?php echo e(route('home')); ?>"> <?php echo e(__('home.home')); ?></a></li>
                                <li><i class="far fa-long-arrow-right"></i></li>
                                <li class="active"> <?php echo e(App::isLocale('en') ? $item->title_en : $item->title_ar); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
       ...
       <!--====== Start About Us Section ======-->
            <section class="about-us-section pt-5 pb-5 dir-rtl">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6">
                            <!--====== Section Image Box ======-->
                            <div class="section-image-box style-one mb-3" data-aos="fade-up" data-aos-delay="30" data-aos-duration="1000">
                                <div class="image-one">
                                    <img src="<?php echo e(asset($item->cover)); ?>" alt="<?php echo e(App::isLocale('en') ? $item->title_en : $item->title_ar); ?>">
                            ...
                            <div class="section-content-box style-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                                <div class="section-title mb-2">
                                    <div class="sub-heading d-inline-flex align-items-center">
                                       <span><a href="#"> <img src="assets/images/icon/star-3.svg" alt="star icon">  
                                        <?php echo e(optional($item->published_at)->format('M d')); ?> ,<?php echo e(optional($item->published_at)->format('Y')); ?>

                                       <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/icon/star-3.svg')); ?>"
                                                    alt="star icon"></a></span>
                                    </div>
                                      
                                    <h2 class="mb-2"><?php echo e(App::isLocale('en') ? $item->title_en : $item->title_ar); ?></h2>
                                </div>
                               
                                <p class="mb-1"><?php echo App::isLocale('en') ? $item->content_en : $item->content_ar; ?>.</p>
...
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/show_blog_details.blade.php ENDPATH**/ ?>