...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mt-3">
          <div class="col-md-6">
            <label class="form-label"><?php echo e(__('messages.parent')); ?></label>
            <select name="parent_id" class="form-control">
              ...
              <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($p->id); ?>" <?php if(old('parent_id') == $p->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-6">
            <label class="form-label"><?php echo e(__('messages.image')); ?></label>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-4">
            ...
            <input type="number" name="home_sort" id="home_sort" class="form-control" value="<?php echo e(old('home_sort', 0)); ?>">
