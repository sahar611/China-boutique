...
<!--====== Start Cart Section ======-->
<section class="cart-page-section pt-5 pb-5 <?php echo e(app()->getLocale()=='ar' ? 'dir-rtl' : ''); ?>">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8">
                <div class="cart-wrapper mb-40" data-aos="fade-up" data-aos-duration="1200">
                   <h3 class="mb-20">
    <?php echo e(app()->getLocale()=='en' ? 'Total Cart Item:' : 'إجمالي عناصر السلة:'); ?>

    <?php echo e(str_pad($itemsCount, 2, '0', STR_PAD_LEFT)); ?>
                    ...
                    <div class="cart-list table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th><i class="fas fa-tshirt"></i><?php echo e(app()->getLocale()=='en' ? 'Products Details' : 'تفاصيل المنتج'); ?></th>
                                    <th><i class="fas fa-sack-dollar"></i><?php echo e(app()->getLocale()=='en' ? 'Price' : 'السعر'); ?></th>
                                    <th style="text-align: center;"><i class="fas fa-eye"></i><?php echo e(app()->getLocale()=='en' ? 'Quantity' : 'الكمية'); ?></th>
                                    <th style="text-align: right;"><i class="fas fa-money-bill"></i><?php echo e(app()->getLocale()=='en' ? 'Total' : 'الإجمالي'); ?></th>
                                </tr>
                            </thead>
...
<tr>
    <td>
        <div class="product-thumb-item">
            <div class="product-img">
                <img src="<?php echo e($image); ?>" alt="Product Thumbnail">
            </div>
    ...
    <td>
        <div class="action-cart">
            ...
            <form action="<?php echo e(route('cart.qty', $product)); ?>" method="POST" class="quantity-form">
              
                  <?php echo csrf_field(); ?>
    <?php echo method_field('PATCH'); ?>
                <div class="quantity-input">
                    <button type="button" class="quantity-down"><i class="far fa-minus"></i></button>
                    <input class="quantity" type="text" name="qty" value="<?php echo e($item->qty); ?>">
...
<tr>
    <td colspan="4" class="text-center">
        <?php echo e(app()->getLocale()=='en' ? 'Your cart is empty' : 'سلة المشتريات فارغة'); ?>
...
<?php endif; ?>
                    ...
                    <div class="cart-bottom d-flex align-items-center justify-content-between mt-40">
                        <div class="ct-shopping">
                            <a href="<?php echo e(route('home')); ?>" class="theme-btn style-one">
                                <?php echo e(app()->getLocale()=='en' ? 'Continue Shopping' : 'متابعة التسوق'); ?>
                        ...
                        <div class="cl-cart">
                            <form action="<?php echo e(route('cart.clear')); ?>" method="POST">
                                ...
                                <button type="submit" class="theme-btn style-one">
                                    <?php echo e(app()->getLocale()=='en' ? 'Clear Cart' : 'تفريغ السلة'); ?>
            ...
            <div class="col-xl-4">
                ...
                <div class="cart-sidebar-area">
                    ...
                    <div class="cart-widget coupon-box-widget mb-40" data-aos="fade-up" data-aos-duration="1200">
                        <h4><?php echo e(app()->getLocale()=='en' ? 'Use Coupon Code' : 'استخدم كود الخصم'); ?></h4>
                        <p><?php echo e(app()->getLocale()=='en' ? 'Enter your coupon code if you have one.' : 'اكتب كود الخصم إن وجد.'); ?></p>

                        
                        <form action="#" method="POST">
                            <input type="text" class="form_control" required>
                            <button class="thme-btn style-one"><?php echo e(app()->getLocale()=='en' ? 'Apply' : 'تطبيق'); ?></button>
                        </form>
                    </div>

                    <!--=== Totals Widget  ===-->
                    <div class="cart-widget cart-total-widget mb-40" data-aos="fade-up" data-aos-duration="1400">
                        <h4><?php echo e(app()->getLocale()=='en' ? 'Cart Totals' : 'إجمالي السلة'); ?></h4>

                      <div class="sub-total">
    <h5>
        <?php echo e(app()->getLocale()=='en' ? 'Subtotal' : 'الإجمالي الفرعي'); ?>
                        ...
                        <div class="shipping-cart">
                            ...
                            <div class="single-radio">
                                ...
                                <label class="form-check-label" for="radio2">
                                    <?php echo e(app()->getLocale()=='en' ? 'Flat Rate' : 'سعر ثابت'); ?>
                            ...
                            <div class="single-radio">
                                ...
                                <label class="form-check-label" for="radio3">
                                    <?php echo e(app()->getLocale()=='en' ? 'Local Area' : 'داخل المدينة'); ?>
...
<div class="price-total">
    <h5>
        <?php echo e(app()->getLocale()=='en' ? 'Total' : 'الإجمالي'); ?>

        <span class="price">$<?php echo e(number_format($total, 2)); ?></span>
    </h5>
</div>

                        <div class="proceced-checkout">
  <?php if(auth()->guard()->guest()): ?>
    <a href="<?php echo e(route('customer.login')); ?>" class="theme-btn style-one">
      <?php echo e(app()->getLocale()=='en' ? 'Login to checkout' : 'سجل الدخول لإتمام الشراء'); ?>
  ...
  <?php else: ?>
    <button class="theme-btn style-one"
            ...
            <?php echo e($itemsCount == 0 ? 'disabled' : ''); ?>>
      <?php echo e(app()->getLocale()=='en' ? 'Proceed to checkout' : 'إتمام الشراء'); ?>
...
<div class="modal fade <?php echo e(app()->getLocale()=='ar' ? 'dir-rtl' : ''); ?> modal-pp"
     id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
     tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <form id="checkoutForm" action="<?php echo e(route('checkout.place')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <?php if(auth()->guard()->check()): ?>
          ...
          <input type="hidden" name="shipping_address" value="<?php echo e(auth()->user()->address); ?>">
          <input type="hidden" name="customer_phone" value="<?php echo e(auth()->user()->phone); ?>">
        <?php endif; ?>

        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">
            <?php echo e(app()->getLocale()=='en' ? 'Choose payment method' : 'اختر طريقة الدفع'); ?>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label class="form-label font-sss">
              <?php echo e(app()->getLocale()=='en' ? 'Payment type:' : 'اختر نوع الدفع:'); ?>

            </label>

            <div class="inbut-c">
              <input type="radio" id="bankTransfer" name="paymentType" value="bank" checked>
              <label for="bankTransfer"><?php echo e(app()->getLocale()=='en' ? 'Bank Transfer' : 'تحويل بنكي'); ?></label>
            </div>

            <div class="inbut-c">
              <input type="radio" id="onlinePayment" name="paymentType" value="online">
              <label for="onlinePayment"><?php echo e(app()->getLocale()=='en' ? 'Online Payment' : 'دفع اون لاين'); ?></label>
            </div>
          </div>

          <div class="mb-3" id="receiptUpload" style="display:block;">
            <label for="receiptImage" class="form-label">
              <?php echo e(app()->getLocale()=='en' ? 'Upload bank receipt:' : 'ارفع صورة الايصال البنكي:'); ?>

            </label>

            <input class="form-control" type="file" id="receiptImage" name="bank_receipt" accept="image/*">

            <?php $__errorArgs = ['bank_receipt'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="modal-footer">
          <button type="submit" class="theme-btn style-one btn-sm">
            <?php echo e(app()->getLocale()=='en' ? 'Send' : 'إرسال'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.layouts.main_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\china\resources\views/front/cart.blade.php ENDPATH**/ ?>