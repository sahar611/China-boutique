                ...
                <div class="row">
                    <div class="col-xl-5">
                        ...
                        <div class="product-gallery-area mb-50 dir-ltr" data-aos="fade-up" data-aos-duration="1200">
                            ...
                            <div class="product-big-slider mb-2">
                                ...
                                $src = $img->path ?? null;
                                $src = $src ? asset($src) :
                                asset('frontend/'.App::getLocale().'/assets/images/products/product-big-1.jpg');
                                ?>
                                ...
                                <div class="product-img">
                                    <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/products/product-big-1.jpg')); ?>"
                                        alt="Product">
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="product-thumb-slider">
                                ...
                                $src = $img->path ?? null;
                                $src = $src ? asset($src) :
                                asset('frontend/'.App::getLocale().'/assets/images/products/product-thumb-1.jpg');
                                ?>
                    ...
                    <div class="col-xl-7">
                        <div class="product-info mb-40" data-aos="fade-up" data-aos-duration="1400">
                            ...
                            <?php endif; ?>
                            <h4 class="title"> <?php echo e(app()->getLocale() === 'ar' ? $product->name_ar : $product->name_en); ?>
                            ...
                            <ul class="ratings rating<?php echo e($avgRounded); ?>">
                                <?php for($i=1;$i<=5;$i++): ?> <li><i class="fas fa-star"></i></li>
                                    <?php endfor; ?>
                            ...
                            <p> <?php echo nl2br(e(app()->getLocale()==='ar' ? ($product->description_ar ?? '') :
                                ($product->description_en ?? ''))); ?></p>
                            <?php endif; ?>
                            <div class="product-price">
                                <?php if($oldPrice): ?>
                                <span class="price prev-price">
                                    <span class="currency"> <?php if($currentCurrency->code =='SAR'): ?>  <img src="<?php echo e(asset('frontend/saudi-riyal.svg')); ?>" width="25px"/> <?php else: ?><?php echo e($symbol); ?><?php endif; ?></span><?php echo e(number_format($oldPrice, 2)); ?>

                                </span>
                                <?php endif; ?>
                                <span class="price new-price"><span class="currency"> <?php if($currentCurrency->code =='SAR'): ?>  <img src="<?php echo e(asset('frontend/saudi-riyal.svg')); ?>" width="25px"/> <?php else: ?><?php echo e($symbol); ?><?php endif; ?></span><?php echo e(number_format($price, 2)); ?></span>
                            </div>

                       <form method="POST" action="<?php echo e(route('cart.add', $product->slug)); ?>">
  <?php echo csrf_field(); ?>

  <?php $sizeType = $product->size_type ?? 'standard'; ?>

  <?php if($sizeType === 'standard'): ?>
    <div class="product-size">
      <h4 class="mb-15"><?php echo e(__('home.size')); ?></h4>
          ...
          <li>
            <div class="form-check">
              <input class="form-check-input"
                     ...
                     <?php if(old('variant_id') == $v->id): echo 'checked'; endif; ?>
                     required>
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php else: ?>
    <?php $dim = $selectedVariant ?? $variants->first(); ?>
    <?php if($dim): ?>
      <div class="product-size">
        <h4 class="mb-15"><?php echo e(__('home.size')); ?></h4>
        <div class="alert alert-light mb-2">
          <?php echo e($dim->label()); ?>

        </div>

        <input type="hidden" name="variant_id" value="<?php echo e($dim->id); ?>">
      </div>
    <?php endif; ?>
  <?php endif; ?>
  ...
  <div class="product-cart-variation">
    <ul>
      ...
      <li>
        <button type="submit" class="theme-btn style-one">
          <?php echo e(__('home.Add_To_Cart')); ?>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo e(route('category.products', $product->category->slug)); ?>">
                                            <?php echo e(app()->getLocale()==='ar' ? $product->category->name_ar :
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo e(route('brand.products', $product->brand->slug)); ?>">
                                            <?php echo e(app()->getLocale()==='ar' ? $product->brand->name_ar :
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li>
                                            <button class="nav-link active" data-bs-toggle="tab"
                                                data-bs-target="#description"><?php echo e(__('home.description')); ?></button>
                                        </li>
                                        <li>
                                                    ...
                                                    <div class="pesco-reviews-item">
                                                        <div class="author-thumb-info">
                                                            <div class="author-thumb">
                                                                <img src="<?php echo e(asset('frontend/'.App::getLocale().'/assets/images/Sample_User_Icon.png')); ?>"
                                                                    alt="Auhthor">
                                                            </div>
                                                            <div class="author-info">
                                                                <h5><?php echo e($r->user->name ?? $r->name ?? __('home.guest')); ?>

                                                                </h5>
                                                                <div class="author-meta">
                                                                    <ul class="ratings rating<?php echo e((int)$r->rating); ?>">
                                                                        <?php for($i=1;$i<=5;$i++): ?> <li><i
                                                                                class="fas fa-star"></i>
                                                </li>
                                                <?php endfor; ?>
    ...
    <form method="POST"
          action="<?php echo e(route('product.reviews.store', $product->slug)); ?>"
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <button type="submit" class="theme-btn style-one">
                    <?php echo e(__('home.submit_review')); ?>
    ...
    <?php else: ?>
        <div class="alert alert-info">
            ...
            <a href="<?php echo e(route('customer.login')); ?>" class="ms-2">
                <?php echo e(__('home.login')); ?>
    ...
    <section class="features-products-section pt-2 pb-2 overflow-hidden">
        <div class="container">
            ...
            <div class="feature-slider-one" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1400">
                ...
                $pHasSale = $pBaseSale > 0 && $pBaseSale < $pBasePrice; $pFinalBase=$pHasSale ? $pBaseSale :
                    $pBasePrice; $pPrice=$pFinalBase * $rate; $pOld=$pHasSale ? ($pBasePrice * $rate) : null;
                    $pDiscount=null; if($pHasSale && $pBasePrice> 0){
                    ...
                    <div class="product-item style-one mb-40 back-p">
                        ...
                        <div class="product-info-wrap">
                            ...
                            <div class="product-price">
                                <?php if($pOld): ?>
                                <span class="price prev-price"><span class="currency"> <?php if($currentCurrency->code =='SAR'): ?>  <img src="<?php echo e(asset('frontend/saudi-riyal.svg')); ?>" width="25px"/> <?php else: ?><?php echo e($symbol); ?><?php endif; ?></span><?php echo e(number_format($pOld,2)); ?></span>
                                <?php endif; ?>
                                <span class="price new-price"><span class="currency"> <?php if($currentCurrency->code =='SAR'): ?>  <img src="<?php echo e(asset('frontend/saudi-riyal.svg')); ?>" width="25px"/> <?php else: ?><?php echo e($symbol); ?><?php endif; ?></span><?php echo e(number_format($pPrice,2)); ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
