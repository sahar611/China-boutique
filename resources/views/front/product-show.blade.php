                ...
                <div class="row">
                    <div class="col-xl-5">
                        ...
                        <div class="product-gallery-area mb-50 dir-ltr" data-aos="fade-up" data-aos-duration="1200">
                            ...
                            <div class="product-big-slider mb-2">
                                ...
                                @empty
                                <div class="product-img">
                                    <img src="{{ asset('frontend/'.App::getLocale().'/assets/images/products/product-big-1.jpg') }}"
                                        alt="Product">
                                </div>
                                @endforelse
                            </div>
                    ...
                    <div class="col-xl-7">
                        <div class="product-info mb-40" data-aos="fade-up" data-aos-duration="1400">
                            ...
                            @endif
                            <h4 class="title"> {{ app()->getLocale() === 'ar' ? $product->name_ar : $product->name_en }}
                            </h4>
                            @php
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('category.products', $product->category->slug) }}">
                                            {{ app()->getLocale()==='ar' ? $product->category->name_ar :
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('brand.products', $product->brand->slug) }}">
                                            {{ app()->getLocale()==='ar' ? $product->brand->name_ar :
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li>
                                            <button class="nav-link active" data-bs-toggle="tab"
                                                data-bs-target="#description">{{ __('home.description') }}</button>
                                        </li>
                                        <li>
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#reviews">{{
                                                __('home.Reviews') }}</button>
                                        </li>
                                    </ul>
                                </div>
                                                    ...
                                                    <div class="pesco-reviews-item">
                                                        <div class="author-thumb-info">
                                                            <div class="author-thumb">
                                                                <img src="{{asset('frontend/'.App::getLocale().'/assets/images/Sample_User_Icon.png')}}"
                                                                    alt="Auhthor">
                                                            </div>
                                                            <div class="author-info">
                                                                <h5>{{ $r->user->name ?? $r->name ?? __('home.guest') }}
                                                                </h5>
