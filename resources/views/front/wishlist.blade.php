                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active">{{ __('home.wishlist') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="cart-wrapper" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1000">
                        ...
                        <div class="cart-list table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th><i class="fas fa-tshirt"></i> {{ __('home.Products_Details') }}</th>
                                        <th><i class="fas fa-sack-dollar"></i> {{ __('home.Unit_Price') }}</th>
                                        <th><i class="fas fa-eye"></i> {{ __('home.Stock_Status') }}</th>
                                        <th><i class="fas fa-rocket-launch"></i> {{ __('home.Action') }}</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    $hasSale = $baseSale > 0 && $baseSale < $basePrice; $finalBase=$hasSale ? $baseSale
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-thumb-item">
                                                    ...
                                                    <div class="product-info">
                                                        <h4 class="title">
                                                            <a href="{{ route('product.show', $p->slug) }}">{{ $pName
                                                                }}</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="price">
                                                    <span class="currrency">{{ $currentCurrency->symbol ?? '﷼' }}</span>
                                                ...
                                                <div class="text-muted" style="font-size: 12px;">
                                                    <del>
                                                        <span class="currrency">{{ $currentCurrency->symbol ?? '﷼'
                                                            }}</span>
                                                        {{ number_format($basePrice * ($currentCurrency->rate ?? 1), 2)
                                                        }}
                                                    </del>
                                                </div>
                                                @endif
                                            ...
                                            <td>
                                                <div class="product-stock {{ $inStock ? '' : 'text-danger' }}">
                                                    {{ $stockText }}
                                                </div>
                                            </td>
...
@endif
                                                    ...
                                                    <a href="javascript:void(0)" class="cart-remove js-wishlist-remove"
                                                        data-url="{{ route('wishlist.remove', $p->slug) }}"
                                                        aria-label="{{ __('home.remove') }}" style="cursor:pointer;">
