...
<main class="main-bg">
     <!--====== Start Page Banner Section ======-->
            ...
            <div class="page-banner-wrapper p-r z-1">
                ...
                <div class="shape shape-three"><span><img src="{{asset('frontend/'.App::getLocale().'/assets/images/shape/curved-arrow.png')}}" alt=""></span>
                </div>
   ...
   <!--===== Start brand Section  ======-->
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="section-title  text-center text-md-start mb-4" data-aos="fade-right"
                            ...
                            <h2>{{ __('home.Browse_All_Brands') }}</h2>
                        </div>
                    </div>
                <div class="col-lg-4">
                            <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30" data-aos-duration="1200">
                                    ...
                                    <input type="text" name="q" value="{{ $q }}"  class="form_control" placeholder="Search Brands" required>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            ...
                            <div class="category-item style-two mb-3 back-red-h" data-aos="fade-up" data-aos-delay="10"
                                ...
                                <div class="category-img">
                                    <img src="{{ asset($brand->logo) }}" alt="  {{ app()->getLocale() === 'ar' ? $brand->name_ar : $brand->name_en }}">
                                </div>
                                <div class="category-content">
                                    <a href="{{ route('brand.products', $brand->slug) }}" class="category-btn">  {{ app()->getLocale() === 'ar' ? $brand->name_ar : $brand->name_en }}</a>
                                    <span>{{ str_pad($brand->products_count, 2, '0', STR_PAD_LEFT) }}  {{ __('home.items') }}</span>
                                </div>
                            </div>
                        </div>
                        @empty
    ...
    @endforelse
                    ...
                    <div class="row text-center mt-4">
                       ...
                       {{ $brands->onEachSide(1)->links('front.layouts.pagination') }}
                    </div>
                    </div>
                </div>
            </div>
