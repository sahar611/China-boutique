    ...
    <section class="category-section pt-5 pb-2 overflow-hidden dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <!--=== Section Title  ===-->
                    <div class="section-title  text-center text-md-start mb-4" data-aos="fade-right" data-aos-delay="10"
                ...
                <div class="col-lg-4">
                    <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30"
                        ...
                        <form method="GET" action="{{ route('brands') }}">
                            ...
                            <input type="text" name="q" value="{{ $q }}" class="form_control"
                        ...
                        <div class="category-item style-two mb-3 back-red-h" data-aos="fade-up" data-aos-delay="10"
                            ...
                            <div class="category-img">
                                <img src="{{ asset($brand->logo) }}"
                                    alt="  {{ app()->getLocale() === 'ar' ? $brand->name_ar : $brand->name_en }}">
                            </div>
                            <div class="category-content">
                                <a href="{{ route('brand.products', $brand->slug) }}" class="category-btn"> {{
                                    app()->getLocale() === 'ar' ? $brand->name_ar : $brand->name_en }}</a>
                                <span>{{ str_pad($brand->products_count, 2, '0', STR_PAD_LEFT) }} {{ __('home.items')
                                    }}</span>
                            </div>
                        </div>
                    </div>
