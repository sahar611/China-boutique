                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active">{{ __('home.trending') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="faqs-search float-md-end mb-60" data-aos="fade-left" data-aos-delay="30"
                           ...
                           <form method="GET" action="{{ route('trending') }}">
                                <input type="text" class="form_control" name="q" value="{{ request('q') }}" placeholder="Search  products" required>
                ...
                <div class="category-wrapper pt-2 all-cat-padd trend">
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-12 text-center">
                            {{ $trendingNow->onEachSide(1)->links('front.layouts.pagination') }}
                        </div>
                    </div>
                </div>
            </div>
