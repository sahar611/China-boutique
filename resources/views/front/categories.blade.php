                        ...
                        <div class="col-lg-6">
                            <div class="page-banner-content">
                                ...
                                <ul class="breadcrumb-link">
                                    ...
                                    <li class="active"> {{ __('home.all_Categories') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="section-title  text-center text-md-start mb-4" data-aos="fade-right"
                            ...
                            <h2> {{ __('home.Browse_All_categories') }}</h2>
                        </div>
                    </div>
                    <div class="col-lg-4">
...
<form method="GET" action="{{ route('categories') }}" >
                           ...
                           value="{{ $q }}" placeholder="{{ __('Search Categories') }}" required>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            ...
                            <div class="category-item style-one text-center">
                                ...
                                <div class="category-content">
                                    <a href="{{ route('category.products', $cat->slug) }}" class="category-btn"> {{ app()->getLocale() === 'ar' ? $cat->name_ar : $cat->name_en }}</a>
                                </div>
                            </div>
                        </div>
                          @empty
  ...
  @endforelse
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-12 text-center">
                           {{ $categories->onEachSide(1)->links('front.layouts.pagination') }}
