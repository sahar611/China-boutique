                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active"> {{ __('home.blogs') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="blogs-wrapper">
                        ...
                        <div class="col-xl-3 col-sm-12">
                            ...
                            <div class="blog-post-item style-two mb-25 ">
                                <div class="post-thumbnail">
                                    <img src="{{ asset($n->cover) }}" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
                                    <div class="post-meta">
                                        <span><a href="{{ route('news.show', $n->slug) }}"> <img src="{{asset('frontend/'.App::getLocale().'/assets/images/icon/star-3.svg')}}" alt="star icon">  
                                            {{ optional($n->published_at)->format('M d') }} ,{{ optional($n->published_at)->format('Y') }}
                                            <img src="{{asset('frontend/'.App::getLocale().'/assets/images/icon/star-3.svg')}}"
                                                    alt="star icon"></a></span>
                                    </div>
                                    <h3 class="title"><a href="{{ route('news.show', $n->slug) }}"> {{ App::isLocale('en') ? $n->title_en : $n->title_ar }}</a></h3>


                                    <p>{{ \Illuminate\Support\Str::limit(strip_tags(App::isLocale('en') ? $n->content_en : $n->content_ar), 140) }}</p>
                    ...
                    <div class="row">
                        <div class="col-xl-12 mt-4">
                             ...
                             {{ $news->onEachSide(1)->links('front.layouts.pagination') }}
                        </div>
                    </div>
                </div>
            </div>
