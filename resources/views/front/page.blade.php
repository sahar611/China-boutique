                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            <h1>
                              {{ App::isLocale('en') ? $page->title_en : $page->title_ar }}

                            </h1>
                            <ul class="breadcrumb-link">
                                <li><a href="{{ route('home') }}"> {{ __('home.home') }}</a></li>
                                <li><i class="far fa-long-arrow-right"></i></li>
                                <li class="active">{{ App::isLocale('en') ? $page->title_en : $page->title_ar }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="section-image-box style-one mb-3" data-aos="fade-up" data-aos-delay="30" data-aos-duration="1000">
                                <div class="image-one">
                                    <img src="{{asset('frontend/'.App::getLocale().'/assets/images/tb4204928_5.jpg')}}" alt="About Image">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="section-content-box style-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                                <div class="section-title mb-2">
                                    ...
                                    <h2 class="mb-2">{{ App::isLocale('en') ? $page->title_en : $page->title_ar }}</h2>
                                </div>
                                <p class="mb-1">{!! App::isLocale('en') ? $page->content_en : $page->content_ar !!}.</p>
  ...
  <div class="col-xl-12">
                            ...
                            <div class="section-content-box style-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                                <div class="section-title mb-2">
                                    <div class="sub-heading d-inline-flex align-items-center">
                                        <i class="flaticon-sparkler"></i>
                                        <span class="sub-title">{{ App::isLocale('en') ? $page->title_en : $page->title_ar }}</span>
                                    </div>
                                    <h2 class="mb-2"> {{ App::isLocale('en') ? $page->title_en : $page->title_ar }}</h2>
                                </div>
                                <p class="mb-1">{!! App::isLocale('en') ? $page->content_en : $page->content_ar !!}.</p>
