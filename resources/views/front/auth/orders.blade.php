                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active">{{ __('home.orders') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="cart-wrapper mb-40" data-aos="fade-up" data-aos-duration="1200">
                                <h3 class="mb-20">{{ __('home.all_orders') }}</h3>
                                <div class="cart-list table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th><i class="fas fa-tshirt"></i> {{ __('home.order_code') }}</th>
                                               <th style="text-align: center;"><i class="fas fa-eye"></i>{{ __('home.Quantity') }}</th>
                                               
                                                <th style="text-align: right;"><i class="fas fa-money-bill"></i>{{ __('home.total') }}</th>
                                                
                                                    <th style="text-align: right;">{{ __('home.status') }}</th>
                                                     <th style="text-align: right;">{{ __('home.date') }}</th>
                                    ...
                                    @endphp
                                        ...
                                        <td style="text-align:right;">
                                            ...
                                            <span class="text-muted">{{ $order->currency_code ?? 'SAR' }}</span>
                                        </td>
                      ...
                      <div class="row text-center mt-4">
                        <div class="col-md-12 text-center">
                            {{ $orders->onEachSide(1)->links('front.layouts.pagination') }}
                        </div>
                    </div>
                </div>
