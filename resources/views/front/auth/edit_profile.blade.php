                    ...
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            ...
                            <ul class="breadcrumb-link">
                                ...
                                <li class="active">{{ __('home.edit_profile') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<section class="contact-section login-form-back pt-5 pb-5 {{ app()->getLocale() == 'ar' ? 'dir-rtl' : '' }}">
    <div class="container">
                ...
                <div class="contact-wrapper p-r z-1 back-all-form"
                    ...
                    <div class="text-center">
                        <h3 class="mb-3 mt-3">
                            ...
                            {{ app()->getLocale() == 'en' ? 'Edit Profile' : 'تعديل الحساب' }}
                            <i class="flaticon-star-2 srarr"></i>
                        </h3>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="text"
                                           name="name"
                                           class="form_control"
                                           placeholder="{{ app()->getLocale() == 'en' ? 'Full Name' : 'الاسم الكامل' }}"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="email"
                                           name="email"
                                           class="form_control"
                                           placeholder="{{ app()->getLocale() == 'en' ? 'Email' : 'البريد الإلكتروني' }}"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group" style="position: relative;">
                                    <input type="password"
                                           ...
                                           class="form_control"
                                           id="editPassword"
                                           placeholder="{{ app()->getLocale() == 'en' ? 'New Password (optional)' : 'كلمة مرور جديدة (اختياري)' }}">
                                    <i class="far fa-eye"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="password"
                                           ...
                                           class="form_control"
                                           placeholder="{{ app()->getLocale() == 'en' ? 'Confirm Password' : 'تأكيد كلمة المرور' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="text"
                                           name="phone"
                                           class="form_control"
                                           placeholder="{{ app()->getLocale() == 'en' ? 'Phone' : 'رقم الجوال' }}"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="text"
                                           name="address"
                                           class="form_control"
                                           placeholder="{{ app()->getLocale() == 'en' ? 'Address' : 'العنوان' }}"
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="form_group">
                                    <button type="submit" class="theme-btn style-one">
                                        {{ app()->getLocale() == 'en' ? 'Save Changes' : 'حفظ التعديلات' }}
                                    </button>
                                </div>
                            </div>
