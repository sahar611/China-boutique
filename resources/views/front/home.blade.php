...
<main class="main-bg">
    ...
    <section class="hero-section">
        ...
        <div class="hero-wrapper-two">
            ...
            <div class="hero-shape bg_cover d-none d-xl-block"
                style="background-image: url({{asset('frontend/'.App::getLocale().'/assets/images/hero/hero-two-shape1.png')}});">
            </div>
            <!--=== Hero Image ===-->
            <div class="hero-image d-none d-xl-block">
                ...
                <div class="hero-img-shape"><img
                        src="{{asset('frontend/'.App::getLocale().'/assets/images/hero/hero-two-img-shape1.png')}}"
                        alt="Image Shape">
                </div>
            </div>
            <div class="container">
                        ...
                        <div class="hero-post-slider mb-50">
                            ...
                            <div class="single-hero-post">
                                <div class="hero-content style-two">
                                    <span class="tag-line"><i class="flaticon-star-2"></i><b>{{
                                        __('home.Best_for_your_categories') }}</b><i class="flaticon-star-2"></i></span>
                                    <h1><span>{{ $firstWords }}</span>{{ $restWords }}</h1>
                                    <p>{{ app()->getLocale() == 'ar' ? $banner->description_ar : $banner->description }}
                                    </p>
                                    <a href="{{ $banner->link ?? '#' }}" class="theme-btn style-one">{{
                                        __('home.shop_now') }}</a>
                                </div>
                            </div>
                            @endforeach
        ...
        <div class="headline-wrap style-one">
            <span class="marquee-wrap">
                <span class="marquee-inner left">
                    ...
                    <span class="marquee-item"> <a href="{{ route('category.products', $homeTabsCategory->slug) }}"
                            class="hover-c"><b>@if (App::isLocale('en')) {{$homeTabsCategory->name_en}}@else
                                {{$homeTabsCategory->name_ar}}@endif</b></a><i class="fas fa-bahai"></i></span>
                    @endforeach
                </span>
                <span class="marquee-inner left">
                    @foreach($homeTabsCategories as $homeTabsCategory)
        ...
        <div class="category-slider-one" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1200">
            ...
            <div class="category-item style-one text-center">
                <div class="category-img">
                    <img src="{{ asset($topCategory->image) }}"
                        alt="@if (App::isLocale('en')) {{$topCategory->name_en}}@else {{$topCategory->name_ar}}@endif">
                </div>
                <div class="category-content">
                   <a href="{{ route('category.products', $topCategory->slug) }}" class="category-btn">
    @if (App::isLocale('en'))
        {{ $topCategory->name_en }}
    @else
        {{ $topCategory->name_ar }}
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                        ...
                        <div class="category-item style-two mb-2 back-red-h" data-aos="fade-up" data-aos-delay="10"
                            ...
                            <div class="category-img">
                                <img src="{{ asset($topBrand->logo) }}"
                                    alt="@if (App::isLocale('en')) {{$topBrand->name_en}}@else {{$topBrand->name_ar}}@endif">
                            </div>
                            <div class="category-content">
                                <a href="{{ route('brand.products', $topBrand->slug) }}" class="category-btn"> 
                                    @if(App::isLocale('en'))
                                     {{$topBrand->name_en}}
                                    @else
                                     {{$topBrand->name_ar}}
                ...
                <div class="col-lg-6">
                    ...
                    <div class="pesco-tabs style-one mb-50" data-aos="fade-left" data-aos-delay="15"
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li>
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#cat2" role="tab">{{
                                    __('home.New_Products') }}</button>
                            </li>
                            <li>
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#cat3" role="tab">{{
                                    __('home.Sale_Products') }}</button>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        : asset('assets/images/products/default.png') }}" alt="Products">
                                            ...
                                            <div class="hover-content">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-url="{{ route('wishlist.toggle', $bestSeller->slug) }}"
  ...
  @if(($bestSeller->size_type ?? 'standard') === 'standard')
    
    <a href="{{ route('product.show', $bestSeller->slug ?? $product->id) }}" class="cart-btn">
...
@else
    ...
    <a href="javascript:void(0)" class="cart-btn js-add-to-cart"
       data-url="{{ route('cart.add', $bestSeller->slug) }}"
...
@endif
                                        ...
                                        <div class="product-info-wrap">
                                            <div class="product-info">
                                                ...
                                                <h4 class="title"><a
                                                        href="{{ route('product.show', $bestSeller->slug ?? $product->id) }}">
                                            ...
                                            <div class="product-price">
                                                <span class="price prev-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                                    ...
                                                    number_format($bestSeller->price * $currentCurrency->rate, 2)
                                                    }}</span>
                                                <span class="price new-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                                    ...
                                                    number_format($bestSeller->sale_price * $currentCurrency->rate, 2)
                                                    }}</span>
                                            </div>
                                            @else
                                            <div class="product-price">
                                                ...
                                                <span class="price new-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                                    ...
                                                    </span>{{ number_format($bestSeller->price * $currentCurrency->rate,
                                                    2) }}</span>
                                            </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="product-item style-one mb-40 back-p">
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="hover-content">
                                                ...
                                                <a href="#"
                                                    class="icon-btn js-wishlist-toggle {{ $isWished ? 'is-active' : '' }}"
                                                    data-url="{{ route('wishlist.toggle', $newProduct->slug) }}"
                                                    aria-label="wishlist"> <i
                                                        class="{{ $isWished ? 'fa fa-heart' : 'far fa-heart' }}"></i>
                                                </a>
                                            ...
                                            <div class="cart-button">
                                                  @if(($newProduct->size_type ?? 'standard') === 'standard')
    
    <a href="{{ route('product.show', $newProduct->slug ?? $newProduct->id) }}" class="cart-btn">
        <i class="far fa-shopping-basket"></i>
        <span class="text">{{ __('home.Add_To_Cart') }}</span>
    </a>
@else
    ...
    <a href="javascript:void(0)" class="cart-btn js-add-to-cart"
       data-url="{{ route('cart.add', $newProduct->slug) }}"
       data-qty-input=".quantity">
        <i class="far fa-shopping-basket"></i>
        <span class="text">{{ __('home.Add_To_Cart') }}</span>
    </a>
@endif
                                        ...
                                        <div class="product-info-wrap">
                                            <div class="product-info">
                                                ...
                                                <h4 class="title"><a
                                                        href="{{ route('product.show', $newProduct->slug ?? $product->id) }}">
                                            ...
                                            <div class="product-price">
                                                <span class="price prev-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                                    ...
                                                    number_format($newProduct->price * $currentCurrency->rate, 2)
                                                    }}</span>
                                                <span class="price new-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                    }}@endif</span>{{
                                                    number_format($newProduct->sale_price * $currentCurrency->rate, 2)
                                                    }}</span>
                                            </div>
                                            @else
                                            <div class="product-price">
                                    ...
                                    <div class="product-item style-one mb-40 back-p">
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="hover-content">
                                                ...
                                                <a href="#"
                                                    class="icon-btn js-wishlist-toggle {{ $isWished ? 'is-active' : '' }}"
                                                    data-url="{{ route('wishlist.toggle', $saleProduct->slug) }}"
                                                    aria-label="wishlist"> <i
                                                        class="{{ $isWished ? 'fa fa-heart' : 'far fa-heart' }}"></i>
                                                </a>
                                            ...
                                            <div class="cart-button">
                                                <!-- <a href="javascript:void(0)" class="cart-btn js-add-to-cart"
                                                    data-url="{{ route('cart.add', $saleProduct->slug) }}"
                                                    data-qty-input=".quantity"><i class="far fa-shopping-basket"></i>
                                                    <span class="text">{{ __('home.Add_To_Cart') }}</span></a> -->
                                            @if(($saleProduct->size_type ?? 'standard') === 'standard')
    
    <a href="{{ route('product.show', $saleProduct->slug ?? $saleProduct->id) }}" class="cart-btn">
        <i class="far fa-shopping-basket"></i>
        <span class="text">{{ __('home.Add_To_Cart') }}</span>
    </a>
@else
...
@endif
                                        ...
                                        <div class="product-info-wrap">
                                            <div class="product-info">
                                                ...
                                                <h4 class="title"><a
                                                        href="{{ route('product.show', $saleProduct->slug ?? $product->id) }}">
                                                        {{ $saleProduct->name }}</a></h4>
                                            </div>
                                            @if($saleProduct->sale_price)
                                            <div class="product-price">
                                                <span class="price prev-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                    }}@endif</span>{{
                                                    number_format($saleProduct->price * $currentCurrency->rate, 2)
                                                    }}</span>
                                                <span class="price new-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                    }}@endif</span>{{
                                                    number_format($saleProduct->sale_price * $currentCurrency->rate, 2)
                                                    }}</span>
                                            </div>
                                            @else
                                            <div class="product-price">
    ...
    <section class="features-products-section pt-5 pb-2 overflow-hidden">
        <div class="container">
            ...
            <div class="feature-slider-one" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1400">
                ...
                <div class="product-item style-one mb-40 back-p">
                    <div class="product-thumbnail">
                        <img src="{{ $homeProduct->mainImageProduct? asset($homeProduct->mainImageProduct->path) : asset('assets/images/products/default.png') }}"
                            alt="Products">
                        ...
                        <div class="hover-content">
                            ...
                            @endphp
                            <a href="#" class="icon-btn js-wishlist-toggle {{ $isWished ? 'is-active' : '' }}"
                                data-url="{{ route('wishlist.toggle', $homeProduct->slug) }}" aria-label="wishlist"> <i
                                    class="{{ $isWished ? 'fa fa-heart' : 'far fa-heart' }}"></i>
                            </a>


                            <a href="{{ $homeProduct->mainImageProduct? asset($homeProduct->mainImageProduct->path) : asset('assets/images/products/default.png') }}"
                                class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                        </div>
                        <div class="cart-button">
                           
                                    @if(($homeProduct->size_type ?? 'standard') === 'standard')
    
    <a href="{{ route('product.show', $homeProduct->slug ?? $homeProduct->id) }}" class="cart-btn">
        <i class="far fa-shopping-basket"></i>
        <span class="text">{{ __('home.Add_To_Cart') }}</span>
    </a>
@else
    ...
    <a href="javascript:void(0)" class="cart-btn js-add-to-cart"
       data-url="{{ route('cart.add', $homeProduct->slug) }}"
       data-qty-input=".quantity">
        <i class="far fa-shopping-basket"></i>
        <span class="text">{{ __('home.Add_To_Cart') }}</span>
    </a>
@endif
                    ...
                    <div class="product-info-wrap">
                        <div class="product-info">
                            ...
                            <h4 class="title"><a
                                    href="{{ route('product.show', $homeProduct->slug ?? $product->id) }}">{{
                                    $homeProduct->name }}</a></h4>
                        </div>
                        @if($homeProduct->sale_price)
                        <div class="product-price">
                            <span class="price prev-price"><span class="currency">
                                @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                    }}@endif</span>{{ number_format($homeProduct->price * $currentCurrency->rate, 2) }}</span>
                            <span class="price new-price"><span class="currency"> @if($currentCurrency->code =='SAR')  <img src="{{asset('frontend/saudi-riyal.svg')}}" width="25px"/> @else{{ $currentCurrency->symbol
                                    }}@endif</span>{{
                                number_format($homeProduct->sale_price * $currentCurrency->rate, 2) }}</span>
                        </div>
                        @else
                        <div class="product-price">
                            ...
                            <span class="price new-price"><span class="currency">
                                ...
                                number_format($homeProduct->price * $currentCurrency->rate, 2) }}</span>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="banner-item style-one bg-one mb-40" data-aos="fade-up" data-aos-delay="10"
                        ...
                        <div class="shape shape-one"><span><img
                                    src="{{asset('frontend/'.App::getLocale().'/assets/images/banner/discount.png')}}"
                                    alt="shape"></span></div>
                        <div class="shape shape-two"><span><img
                                    src="{{asset('frontend/'.App::getLocale().'/assets/images/banner/line.png')}}"
                                    alt="shape"></span></div>
                        <div class="banner-img"><img
                                src="{{ $banner->image ? asset($banner->image) : asset('assets/images/banner/banner-1.png') }}"
                                alt="banner image">
                        </div>
                        <div class="banner-content">
                            <span>{{ __('home.up_to') }} <span class="off">{{ $banner->discount_percent
                                    }}%</span></span>
                            <h4> {{ $banner->title }}</br>{{ $banner->subtitle }}</h4>
                            <a href="{{ $banner->link ?? '#' }}" class="theme-btn style-one">{{ __('home.shop_now')
                                }}</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="trending-products-slider" data-aos="fade-up" data-aos-duration="1400">
                ...
                <div class="product-item style-two">
                    <div class="product-thumbnail">
                        <img src="{{ $trending->mainImageProduct? asset($trending->mainImageProduct->path) : asset('assets/images/products/default.png') }}"
                            alt="Products">
                    </div>
                    <div class="product-info-wrap">
                        <div class="product-info">
                            ...
                            <h4 class="title"><a href="{{ route('product.show', $trending->slug ?? $product->id) }}">{{
                                    $trending->name }}</a></h4>
                        </div>
    ...
    <section class="newsletter-section">
        <div class="newsletter-wrapper-two p-r z-1 pt-80 pb-85">
            <div class="newsletter-image-two" data-aos="fade-left" data-aos-duration="1200"><img
                    src="{{asset('frontend/'.App::getLocale().'/assets/images/hannah-morgan-ycVFts5Ma4s-unsplash.jpg')}}"
                    ...
                    <div class="col-xl-6">
                        <div class="section-content-box" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="section-title">
                                <div class="sub-heading d-inline-flex align-items-center">
                                    <i class="flaticon-sparkler"></i>
                                    <span class="sub-title">{{ __('home.newsletter_title_small') }}</span>
                                </div>
                                <h2> {!! __('home.newsletter_title_main') !!}</h2>
                            </div>
