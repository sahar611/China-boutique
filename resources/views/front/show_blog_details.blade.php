                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-banner-content">
                            <h1> {{ __('home.blog_details') }}</h1>
                            <ul class="breadcrumb-link">
                                <li><a href="{{ route('home') }}"> {{ __('home.home') }}</a></li>
                                <li><i class="far fa-long-arrow-right"></i></li>
                                <li class="active"> {{ App::isLocale('en') ? $item->title_en : $item->title_ar }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="section-image-box style-one mb-3" data-aos="fade-up" data-aos-delay="30" data-aos-duration="1000">
                                <div class="image-one">
                                    <img src="{{ asset($item->cover) }}" alt="{{ App::isLocale('en') ? $item->title_en : $item->title_ar }}">
                                ...
                                <div class="section-title mb-2">
                                    <div class="sub-heading d-inline-flex align-items-center">
                                       <span><a href="#"> <img src="assets/images/icon/star-3.svg" alt="star icon">  
                                        {{ optional($item->published_at)->format('M d') }} ,{{ optional($item->published_at)->format('Y') }}
                                       <img src="{{asset('frontend/'.App::getLocale().'/assets/images/icon/star-3.svg')}}"
                                                    alt="star icon"></a></span>
                                    </div>
                                      
                                    <h2 class="mb-2">{{ App::isLocale('en') ? $item->title_en : $item->title_ar }}</h2>
                                </div>
                               
                                <p class="mb-1">{!! App::isLocale('en') ? $item->content_en : $item->content_ar !!}.</p>
