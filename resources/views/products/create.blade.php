            ...
            <div class="row">
              ...
              <!-- <div class="col-md-3">
                ...
                <select name="track_stock" class="form-control @error('track_stock') is-invalid @enderror">
                  <option value="1" @selected(old('track_stock','1')=='1')>{{ __('messages.yes') }}</option>
                  <option value="0" @selected(old('track_stock')=='0')>{{ __('messages.no') }}</option>
                </select>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <input type="number" name="home_sort"
                       class="form-control @error('home_sort') is-invalid @enderror"
                       value="{{ old('home_sort',0) }}">
